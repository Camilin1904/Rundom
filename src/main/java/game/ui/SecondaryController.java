...
public class SecondaryController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        switch(ctrl.getActual().getPosScore().getFloor()){
            ...
            case(1):
                String uri1 = "file:"+ Rundom.class.getResource("wall.png").getPath();
                wall = new Image(uri1);
                ...
                break;
            case(2):
                String uri11 = "file:"+ Rundom.class.getResource("wall2.png").getPath();
                wall = new Image(uri11);
                String uri22 = "file:"+ Rundom.class.getResource("suelo2.png").getPath();
                bg = new Image(uri22);
                String uri33 = "file:"+ Rundom.class.getResource("key.png").getPath();
                key = new Image(uri33);
                String uri44 = "file:"+ Rundom.class.getResource("slime.png").getPath();
                slime = new Image(uri44);
                break;
            case(3):
                String uri111 = "file:"+ Rundom.class.getResource("wall3.png").getPath();
                wall = new Image(uri111);
                String uri222 = "file:"+ Rundom.class.getResource("suelo3.png").getPath();
                bg = new Image(uri222);
                String uri333 = "file:"+ Rundom.class.getResource("key.png").getPath();
                key = new Image(uri333);
                String uri444 = "file:"+ Rundom.class.getResource("slime.png").getPath();
                slime = new Image(uri444);
                break;
            case(4):
                String uri1111 = "file:"+ Rundom.class.getResource("wall4.png").getPath();
                wall = new Image(uri1111);
                String uri2222 = "file:"+ Rundom.class.getResource("suelo4.png").getPath();
                bg = new Image(uri2222);
                String uri3333 = "file:"+ Rundom.class.getResource("key.png").getPath();
                key = new Image(uri3333);
                String uri44444 = "file:"+ Rundom.class.getResource("slime.png").getPath();
                slime = new Image(uri44444);
                break;
        }
